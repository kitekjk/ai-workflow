...
describe("GitHub implementation local runner engine", () => {
  ...
  it("runs initial implementation in a checked-out branch before opening the pull request", async () => {
      ...
      async run({ job, workspaceDir }) {
        ...
        return {
          output: {
            ...
            pullRequestTitle: "Implement SPEC-100 from AI summary",
            pullRequestBody: "## Summary\n- Implemented SPEC-100.\n\n## Tests\n- unit tests passed.\n\n## Review notes\n- Generated by the local runner."
          }
        };
      }
    };
    ...
    expect(result).toMatchObject({
      ...
      result: {
        output: {
          ...
          pullRequestUrl: "https://github.com/acme/workflow-app/pull/42",
          pullRequestTitle: "Implement SPEC-100 from AI summary",
          pullRequestBody: expect.stringContaining("unit tests passed"),
          runnerSkill: {
            id: "implementation.pr-author",
            version: "0.1.0"
          }
    ...
    expect(documentRepository.artifacts).toMatchObject([
      {
        ...
        metadata: {
          ...
          pullRequestTitle: "Implement SPEC-100 from AI summary",
          pullRequestBody: expect.stringContaining("Generated by the local runner."),
          pullRequestBodySource: "ai",
          runnerSkill: {
            id: "implementation.pr-author",
            version: "0.1.0"
          }
    ...
    expect(githubServer.requests.at(-1)?.body).toMatchObject({
      title: "Implement SPEC-100 from AI summary",
      body: expect.stringContaining("Generated by the local runner."),
